 ...
 * scroll={false} + flushBottom: the custom tab bar sits in normal flow below the scene, so the
 * scene ends at the bar's top — flushBottom (Screen.tsx) drops the redundant tab-bar clearance
 * so Sign out pins just above the bar. The flex:1 `center` region holds the avatar/email block
 * vertically centered between the title and Sign out.
 */
